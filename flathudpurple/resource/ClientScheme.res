...
Scheme
{
	...
	{	
		...
		"MenuBorder"    "209 0 209 255"                  //Border stuff on main menu (for MOTD, alerts, and the lines on the mainmenu)
		"MenuMouseover" "181 0 181 255"                  //Mouseover color
		"MenuTabs"      "166 0 166 255"                  //Tabs border on menus; footers and headers for menu stuff also thin border on buttons (like the back button)
		"MenuDark"      "222 0 222 255"                  //Darker borders (not used very often)
		"MenuHover"     "168 0 168 255"                  //Hover color (only used in matchmaking and quickplay)
		...
		//Changes the colors of the bars on the "Stats" tab
			...
			"StatBar1"						"255 0 255 128"
			"StatBar2"						"245 0 245 128"
			"StatBar3"						"235 0 235 128"
			"StatBar4"						"225 0 225 128"
			"StatBar5"						"215 0 215 128"
			"StatBar6"						"205 0 205 128"
			"StatBar7"						"195 0 195 128"
			"StatBar8"						"185 0 185 128"
			"StatBar9"						"175 0 175 128"
